...
// Encoder Direction
#define STM32E_POSITIVE    0
#define STM32E_NEGATIVE    1

// Encoder Polarity
#define STM32E_NORMAL      0
#define STM32E_INVERTED    1

// Angle calculation definitions
#define STM32E_DEGREES     0
#define STM32E_GRADES      1
#define STM32E_RADIANS     2

// remap_type for remapInputs()
#define STM32E_NO_REMAP         0
#define STM32E_PARTIAL_REMAP    1
#define STM32E_FULL_REMAP       3

// count_mode for constructor
...
class STM32Encoder {
    private: 
        ...
        //every time there is an interrupt, this variable is inc or decremented 
        // unsigned long _revolutions; 
        timer_dev * _TIMER;
    ...
    public: 
         ...
         * count_mode         - Counting edges on both channels or just one and 
         *                      if so, which.
         * prescaler          - Timer prescaler value. Useful to only count 
         *                      positive flanks if set to two.
         * pulsePerRevolution - number of pulses per Revolution on the encoder. 
         *                      Used for the Angle calculation, interrupt 
         *                      trigger and reload value on the counter. 
         */
         ...
         * depending on where the encoder was reset and the number of pulses 
         * per revolution set,  This function will calculate the current angle 
         * of the shaft. 
         * base - units in which to present the angle. Possible Values: 
         *      STM32E_DEGREES, STM32E_RADIANS, STM32E_GRADIANS
         */
        ...
        /*
         * Remap encoder input pins per the spec sheet.
         * val - ????
         */
        void STM32Encoder::remapInputs(unsigned char val) { 
};
